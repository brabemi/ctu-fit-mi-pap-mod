...
Měření je graficky znázorněno v předposlední sekci věnované Xeonu Phi, kde je zároveń i grafické porovnání s variantou s vektorizací a grafy paralelního zrychlení.
%
% 1. měření
%
\begin{center}
...
\subsection{Grafické porovnání obou variant}
V této sekci jsou do grafů vyneseny časy z jednotlivých měření pro Xeon Phi, v každém grafu je vynesen čas jak pro variantu bez vektorizace, tak s vektorizací.
Poté následují grafy paralelního zrychlení pro jednotlivá měření, opět s porovnáním obou variant.
%
% 1. měření - časy
%
\begin{figure}
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi1t.png}	
    \caption{Porovnání implementací dle výpočetního času, měření 1}
  \end{center}
\end{figure}
%
% 2. měření - časy
...
\begin{figure}
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi2t.png}	
    \caption{Porovnání implementací dle výpočetního času, měření 2}
  \end{center}
\end{figure}
%
% 3. měření - časy
...
\begin{figure}
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi3t.png}	
    \caption{Porovnání implementací dle výpočetního času, měření 3}
  \end{center}
\end{figure}
%
% 4. měření - časy
...
\begin{figure}
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi4t.png}	
    \caption{Porovnání implementací dle výpočetního času, měření 4}
  \end{center}
\end{figure}
%
% 1. měření - zrychlení
...
\begin{figure}
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi1acc.png}	
    \caption{Porovnání implementací dle zrychlení, měření 1}
  \end{center}
\end{figure}
%
% 2. měření - zrychlení
...
\begin{figure}
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi2acc.png}	
    \caption{Porovnání implementací dle zrychlení, měření 2}
  \end{center}
\end{figure}
%
% 3. měření - zrychlení
...
\begin{figure}
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi3acc.png}	
    \caption{Porovnání implementací dle zrychlení, měření 3}
  \end{center}
\end{figure}
%
% 4. měření - zrychlení
...
\begin{figure}[H]
  \begin{center}
      \includegraphics[width=12cm]{images/phi/phi4acc.png}	
    \caption{Porovnání implementací dle zrychlení, měření 4}
  \end{center}
\end{figure}
