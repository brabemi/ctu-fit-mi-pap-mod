...
Xeon Phi dosáhl nejvyššího zrychlení 63 na stejné množině dat. V jednotkách času byl Xeon v tomto měření pomalejší o přibližně 2 vteřiny.
...
a tedy už jsou ovlivněny automatickou optimalizací a vektorizací, která výpočet zrychlila přibližně 6*.
